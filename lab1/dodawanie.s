...
add:
	...
	# dodawanie wykonujemy na akumulatorze (eax) oraz ebx, tak więc tam wkladamy
	# kolejne fragmenty danych liczb, na ktore wskazuja rejestry edi i esi

	movl l1(,%edi, 4), %eax 
	movl l2(,%esi, 4), %ebx

	# faktyczne dodawanie (wynik w akumulatorze)
	adcl %ebx, %eax
	...
	# dekrementacja esi i edi, aby dodac kolejny fragment liczby
...
add_edi:
	...
	# dodawanie zera, reszta dzieje sie analogicznie
	adcl $0, %eax
	push %eax 
	dec %edi #
	pushf
